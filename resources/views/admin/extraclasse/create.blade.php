                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="atividade" autofocus class="form-control" placeholder="Ex: Catequese, Escolinha, etc..." value="{{old('atividade')}}">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <textarea name="descricao_atv" id="" cols="30" rows="7" class="form-control">{{old('descricao_atv')}}</textarea>
